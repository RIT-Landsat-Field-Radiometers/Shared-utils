...
#define CO_CANrxMsg_readIdent(msg) ((uint16_t)((CO_CANrxMsg_t *)msg)->RxHeader.StdId)
#define CO_CANrxMsg_readDLC(msg)   ((uint8_t)((CO_CANrxMsg_t *)msg)->RxHeader.DLC)
